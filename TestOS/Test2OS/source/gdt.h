...
Each entry is called segment descriptor which should define - base address of the segment, Size of the segment, access rights, privilege level, segment type.
*/
struct gdt_entry
{
